...
--
-- Client: 127.0.0.1
-- Généré le : Jeu 20 Juillet 2017 à 01:26
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `credit_maximum` int(11) NOT NULL,
...
(1, 'Mr', 'ola', 'olouwa', '', '', '1977-07-01', 'ola@pharma.com', 'kleve', 2147483647, 2147483647, '1', 0, 5000, 30, 5, 1, 1, '0000-00-00 00:00:00'),
(2, 'Mme', 'kossiwa', 'eugenie', '', '', '2008-07-01', 'eugenie@pharma.com', 'sogbossiti', 229855252, 96585856, '0', 50000, 1000000, 45, 0, 0, 1, '0000-00-00 00:00:00');
...
INSERT INTO `commerciale` (`code_com`, `nom_com`, `prenom_com`, `date_emb`, `tel_com`, `tel_urg`, `chiffre`, `pourcentage`) VALUES
...
INSERT INTO `fournisseur` (`code_fournisseur`, `raison_social`, `contact`, `tel`, `email`, `adresse`, `solde_compte`) VALUES
(1, 'ROOK IT ASSOCIATE', '', 90894549, 'rooktimail@gmail.com', 'agoe kleve super', 0),
(2, 'Euck IT ', '', 93231033, 'eugenienantis@gmail.com', 'agoe telessou', 0);
