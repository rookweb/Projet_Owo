...
<style type="text/css">
	...
	#table tr td{border: 1px solid #aaa; width: 25%; text-align:left; text-decoration:blink; padding: 15px}
...
<page backtop='60mm' footer="date;heure;page;">
	...
	<page_footer>
		<hr>
                    ...
                    <h2 align="center" >LISTE DES ENCAISSEMENTS</h2>

	<table id="table" margin-top>

	       <thead>
				<tr>
                       <th class="chiffre">Date</th>
                       <th>Client</th>
                       <th>Operateur</th>
                       <th class="chiffre">Identifiant de vente</th>
                       <th>Montant</th>
                  </tr>
		  </thead>
...
try {
	...
	$pdf->Output("Liste des encaissements.pdf");
