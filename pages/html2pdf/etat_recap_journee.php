...
<page backtop='60mm' footer="date;heure;page;">
	...
	<page_footer>
		<hr>
                    ...
                    <h2 align="center" >RECAP DE LA JOURNEE</h2>

	<table id="table" margin-top>

	       <thead>
	              <tr>
                                        <th class="chiffre">Journee</th>
                                        <th>Utilisateur ouverture journee</th>
                                        <th class="chiffre">Date ouverture journee</th>
                                        <th class="chiffre">Heure ouverture</th>
                                        <th>Utilisateur fermeture journee</th>
                                        <th class="chiffre">Date fermerture journee</th> 
                                        <th class="chiffre">Heure fermeture</th>          
                   </tr>
		  </thead>
...
try {
	...
	$pdf->Output("Liste des comptes client.pdf");
