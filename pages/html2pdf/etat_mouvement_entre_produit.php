...
<style type="text/css">
	...
	#table tr td{border: 1px solid #aaa; width: 20%; text-align:center; text-decoration:blink; padding: 15px}
...
<page backtop='60mm' footer="date;heure;page;">
	...
	<page_footer>
		<hr>
                    ...
                    <h2 align="center" >LISTE DES ENTREES PRODUITS</h2>

	<table id="table" margin-top>

	       <thead>
				         <tr>
                      <th class="chiffre">Code CIP</th>
                      <th>Designation</th>
                      <th>DCI</th>
                      <th class="chiffre">Forme</th>
                      <th class="chiffre">Prix achat</th>
                  </tr>
		  </thead>
...
try {
	...
	$pdf->Output("Liste des produits entres.pdf");
