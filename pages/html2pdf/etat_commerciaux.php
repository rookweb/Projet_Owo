...
<style type="text/css">
	...
	#table tr th{border: 1px solid #aaa; width: 20%; text-align:center; padding: 15px}
	#table tr td{border: 1px solid #aaa; width: 20%; text-align:left; text-decoration:blink; padding: 15px}
	...
	<table id="table" margin-top>
	       ...
	       <thead>
				<tr>
                     <th>Nom</th>
                     <th>Prenom</th>
                     <th class="chiffre">Date embauche</th>
                     <th class="chiffre">Telephone </th>
                     <th class="chiffre">Commission total</th>
                     <th class="chiffre">Montant payé</th>
                     <th class="chiffre">Reste a payer</th>
                     <th class="chiffre">Date payement</th>
                  </tr>
		  </thead>
		   ...
		   <tbody>	
                  <?php while ($donnees = $reponse->fetch()){  ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="chiffre"><?php echo $donnees['DATE_EMB']; ?></td>
                                        <td class="chiffre"><?php echo $donnees['TEL_COM']; ?></td>
