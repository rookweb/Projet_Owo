...
*/
        ...
        if (!$json['erreur']) {//Pas d erreur
            ...
            if ($req->rowCount() != 0) {
                ...
                $req = $bdd->prepare("INSERT INTO commerciale ( nom_com, prenom_com,date_emb,email, adresse, tel_com, tel_urg,chiffre, pourcentage)
                                                VALUES(:nom_com,:prenom_com,:date_emb,:email, :adresse, :tel_com, :tel_urg,:chiffre,:pourcentage)");
                $req->execute(array(
                    'nom_com'=>$nom,
                    'prenom_com'=>$prenom,
                    'date_emb'=>$embauche,
