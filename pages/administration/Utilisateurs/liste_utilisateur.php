                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                               ...
                               <?php foreach ($data as $d){?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a class="btn btn-outline btn-primary fa fa-edit" href="?page=update_utilisateur&amp;id=<?php echo $d->CODE_USER; ?>"> Modifier</a>
                                            ...
                                            <a class="btn btn-outline btn-warning fa fa-refresh" href="?page=reload_mdp&amp;id=<?php echo $d->CODE_USER; ?>"> Reinitialiser</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
