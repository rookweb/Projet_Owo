            ...
            <ul class="nav navbar-top-links navbar-right">
			 <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-wrench fa-fw"></i><i class="fa fa-shopping-basket fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
							...
							<ul class="nav nav-second-level">
					           ...
					           <li>
                                    <a href="index.php?page=produit"><i class="fa fa-plus-square fa-fw"></i> Ajouter un produit</a>
                                </li>
								
								<li>
                                    <a href="index.php?page=list_produit"><i class="fa fa-table fa-fw"></i> Liste Produits</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="?page=client"><i class="fa fa-table fa-fw"></i> Liste des clients</a>
                                </li>
                                <li>
