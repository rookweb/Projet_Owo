...
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Liste des tickets de caisse</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                               ...
                               <?php while ($donnees = $produits->fetch()){  ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a class="btn btn-outline btn-primary fa fa-gear" href="?page=modif_ticket">Modifier</a>
                                            <a class="btn btn-outline btn-success fa fa-times" href="#">annuler</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
